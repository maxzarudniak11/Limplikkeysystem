...
local Config = {
    ...
    ServiceId       = 27879, -- Your PlatoBoost Service ID
    PlatoSecret     = "721636f9-1634-4331-931f-573ef3bd65eb", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "LimplikUniversalScript", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/maxzarudniak11/Limplikkeysystem/refs/heads/main/script.lua", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "Universal Script", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "Universal Script", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "LimplikScripts", -- The main title shown at the top of the GUI
